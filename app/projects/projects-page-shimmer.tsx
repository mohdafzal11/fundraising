...
const FilterSectionSkeleton = () => (
  <FadeIn>
    <div className="bg-card rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-10 animate-pulse">
...
export default function ProjectsPageShimmer() {
  return (
