...
const InvestorCardSkeleton = () => (
  <FadeIn>
    <div className="p-4 md:p-6 border rounded-2xl shadow-md bg-card flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 mb-8">
      <div className="flex items-center gap-4 md:gap-6">
        <div className="h-16 md:h-20 w-40 md:w-48 bg-gray-200 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg animate-pulse" />
      </div>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {Array.from({ length: 10 }).map((_, index) => (
              <>
                <tr
                  key={index}
                  className="hover:bg-gray-100 dark:hover:bg-gray-700/50 animate-pulse"
                >
                  ...
                  <td className="px-6 py-5 whitespace-nowrap">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-700" />
                      <div className="space-y-2">
                  ...
                  <td className="px-6 py-5 whitespace-nowrap">
                    <div className="h-7 w-20 bg-gray-200 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-700 rounded-full" />
                  </td>
                  <td className="px-6 py-5 whitespace-nowrap">
                    <div className="flex items-center space-x-2">
                  ...
                  <td className="px-6 py-5">
                    <div className="flex flex-wrap gap-2">
                      <div className="h-7 w-16 bg-gray-200 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-700 rounded-full" />
                      <div className="h-7 w-20 bg-gray-200 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-700 rounded-full" />
                      <div className="h-7 w-12 bg-gray-200 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-full" />
                    </div>
                  </td>
                  <td className="px-6 py-5">
                    <div className="flex flex-wrap gap-2">
                      <div className="h-7 w-24 bg-gray-200 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-full" />
                      <div className="h-7 w-20 bg-gray-200 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-full" />
                      <div className="h-7 w-12 bg-gray-200 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-full" />
                    </div>
                  </td>
                </tr>
  ...
  <FadeIn>
    <div className="p-6 flex justify-center">
      <div className="inline-flex rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 bg-card animate-pulse">
        <div className="px-3 py-2 rounded-l-lg border-r border-gray-200 dark:border-gray-700 w-10 h-10 bg-gray-200 dark:bg-gray-700" />
        ...
        <div className="px-3 py-2 rounded-r-lg border-l border-gray-200 dark:border-gray-700 w-10 h-10 bg-gray-200 dark:bg-gray-700" />
      </div>
    </div>
  </FadeIn>
);

export default function InvestorPageShimmer() {
  return (
